...
const setCredential = (authorName, projectId, secretKey) => {
    __("#authorName").value = authorName;
    __("#projectId").value = projectId;
    __("#somethingSpecial").value = secretKey;
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (Cached()) {
        const {authorName, projectId, secretKey} = getCached();
        setCredential(authorName, projectId, secretKey);
    }
});
